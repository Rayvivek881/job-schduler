...
var (
	...
	ErrJobTimeout           = errors.New("job execution failed: job execution timeout exceeded")
	ErrJobProcessorNotFound = errors.New("job execution failed: no processor found for job type")
)
