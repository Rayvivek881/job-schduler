...
type jobConfig struct {
	...
	JobExecutionTimeout int `mapstructure:"JOB_EXECUTION_TIMEOUT"` // Timeout in minutes
}
...
func (v *Viper) setDefaults() {
	...
	// Set explicit defaults for numeric values
	viper.SetDefault("JOB_EXECUTION_TIMEOUT", 30) // 30 minutes default
