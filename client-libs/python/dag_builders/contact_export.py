...
def create_contact_export_dag(
    ...
    This DAG exports filtered contact data from the database to a CSV file in S3.
    ...
    Example:
        >>> # Simple export with keyword filter
    ...
    """
    if not workflow_id:
        workflow_id = BaseDAGBuilder.generate_workflow_id("contact-export")
    ...
    dag = [
        BaseDAGBuilder.build_job_node(
            uuid=workflow_id,
            job_title=f"Export Contacts to CSV (limit: {limit or 'unlimited'})",
